...
function updateChords() {
    var a = chordsSvg.selectAll("g.arc").data(chords, function (a) {
        return a.label
    }), b = a.enter().append("g").attr("class", "arc"), c = defs.selectAll(".arcDefs").data(labelChords, function (a) {
        return a.label
    });
    c.enter().append("path").attr("class", "arcDefs").attr("id", function (a, b) {
        ...
        var c = d3.svg.arc().innerRadius(1.05 * innerRadius).outerRadius(1.05 * innerRadius)(a), d = /[Mm][\d\.\-e,\s]+[Aa][\d\.\-e,\s]+/, e = d.exec(c)[0];
        return e
